...
# --- workload distribution --- BF16 variant. (B, T, H, K, V, M).
# NOTE: the logcumsumexp/softmax gate derivation is bf16-unstable at K=128/M=64
# (same NaN failure mode as gsa), so the bf16 variant uses K=64/M=32 slot configs
# where the bf16 tensor-core path is numerically stable. Tolerance 2e-2.
WORKLOAD = [
    (1, 128, 4, 64, 64, 32),
    (2, 256, 4, 64, 64, 32),
    (1, 512, 8, 64, 64, 32),
