...
# --- workload distribution --- BIG-DIM variant. (B, T, H, K, V). chunk=64.
# Large head dim K=V=256: the intra-chunk k-by-v outer-product matmul (256x256
# state per head) is the optimization target. (rwkv6's chunk kernel runs bf16
# internally regardless; inputs stay fp32.)
WORKLOAD = [
    (1, 256, 4, 256, 256),
    (2, 256, 8, 256, 256),
    (1, 512, 4, 256, 256),
]
_DEF_D = (1, 256, 4, 256, 256)
