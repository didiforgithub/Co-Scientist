...
# --- workload distribution --- LONG-SEQUENCE variant. (B, T, H, K, V, nh).
# Large T (B=1, H=8, K=V=128, nh=2): the expanded (T*nh) delta-product scan
# dominates. T capped at 2048 so the naive oracle stays tractable. bf16 inputs.
WORKLOAD = [
    (1, 1024, 8, 128, 128, 2),
    (1, 2048, 8, 128, 128, 2),
]
_DEF_L = (1, 1024, 8, 128, 128, 2)
