...
# Large T (B=1, H=8, K=V=128, M=64): the two inter-chunk slot recurrences
# dominate cost, so the chunk-to-chunk slot-state scan is the optimization target.
WORKLOAD = [
    (1, 1024, 8, 128, 128, 64),
    (1, 2048, 8, 128, 128, 64),
    (1, 4096, 8, 128, 128, 64),
