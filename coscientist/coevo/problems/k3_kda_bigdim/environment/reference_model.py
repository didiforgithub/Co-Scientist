...
# (B, T, H, HV, K, V). H=key/query heads, HV=value heads (GVA), K=V=head dim, chunk=64.
WORKLOAD = [
    (1, 128, 4,  8,  128, 128),   # smoke, dim 128
    (2, 256, 8, 16, 256, 256),    # bigdim K=V=256
    (1, 512, 8, 16, 256, 256),    # bigdim, longer seq
    (2, 256, 4,  8,  256, 256),   # bigdim GVA groups=2
]

_DEF = (1, 128, 4, 8, 128, 128)
