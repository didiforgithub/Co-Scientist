...
# (B, T, H, K, V, num_householder). K=V=head dim. bf16 inputs (chunk requires it).
WORKLOAD = [
    (4,  128, 4, 128, 128, 2),   # bigbatch smoke
    (8,  256, 4, 128, 128, 2),   # bigbatch medium
    (16, 256, 8, 128, 128, 2),   # bigbatch large
    (8,  512, 8, 128, 128, 2),   # bigbatch longer seq
]

_DEF = (1, 128, 4, 64, 64, 2)
