...
# --- workload distribution --- LONG-SEQUENCE variant. (B, T, H, K, V, M).
# Large T (B=1, H=8, K=V=128, M=64): the two inter-chunk slot recurrences plus
# the in-kernel gate derivation dominate cost. T capped at 2048.
WORKLOAD = [
    (1, 1024, 8, 128, 128, 64),
    (1, 2048, 8, 128, 128, 64),
]
_DEF_L = (1, 1024, 8, 128, 128, 64)
