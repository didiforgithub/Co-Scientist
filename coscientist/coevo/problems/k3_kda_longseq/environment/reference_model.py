...
# --- workload distribution --- LONG-SEQUENCE variant. (B, T, H, HV, K, V).
# Large T (B=1, H=8, HV=16, K=V=128): inter-chunk GVA delta scan dominates. T
# capped at 2048 so the naive O(T) recurrent oracle stays tractable.
WORKLOAD = [
    (1, 1024, 8, 16, 128, 128),
    (1, 2048, 8, 16, 128, 128),
]
_DEF_L = (1, 1024, 8, 16, 128, 128)
