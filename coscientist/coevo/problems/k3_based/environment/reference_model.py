...
# --- workload distribution --- (B, T, H, K, V). K <= 16 (Taylor feature dim).
WORKLOAD = [
    (1, 128, 4,  16, 64),    # small smoke
    (2, 256, 4,  16, 64),    # medium
    (1, 512, 8,  16, 128),   # larger seq / heads
    (2, 512, 8,  16, 128),   # batch + heads
]
