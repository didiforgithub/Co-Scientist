...
# (B, T, H, K, V). K=V=head dim. chunk_gdn2 requires chunk_size=64.
WORKLOAD = [
    (1, 128, 4,  64,  64),   # small smoke
    (2, 256, 4, 128, 128),   # medium, real head dim
    (1, 512, 8, 128, 128),   # longer seq
    (2, 256, 8, 128, 128),   # more heads
]
